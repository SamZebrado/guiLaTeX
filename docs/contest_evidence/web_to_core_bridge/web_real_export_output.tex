...
% Export date: 2026-04-12 16:20:41
...
\begin{tikzpicture}[remember picture, overlay]
  % Layer 1: 1
  \node[anchor=north west, rotate=0, text width=400mm, align=left, font=\fontsize{24}{28.799999999999997}\selectfont, color={rgb,1:red,0.0;green,0.0;blue,0.0}, visible on layer=1]
  ...
  % Layer 4: 4
  \node[anchor=north west, rotate=0, text width=150mm, align=left, font=\fontsize{18}{21.599999999999998}\selectfont, color={rgb,1:red,0.0;green,0.0;blue,0.0}, visible on layer=4]
    at (100mm, 17mm) {E = mc² (文本框)};
  % Layer 5: 5
  \node[anchor=north west, rotate=0, text width=200mm, align=left, font=\fontsize{12}{14.399999999999999}\selectfont, color={rgb,1:red,0.0;green,0.0;blue,0.0}, visible on layer=5]
