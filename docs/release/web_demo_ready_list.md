...
- **证据文件**：
  - [regression_initial_page.png](<repo-root>/web_prototype/regression_initial_page.png)
...
- **证据文件**：
  - [regression_click_teleportation.png](<repo-root>/web_prototype/regression_click_teleportation.png)
...
- **证据文件**：
  - [regression_multi_select_rotation.png](<repo-root>/web_prototype/regression_multi_select_rotation.png)
...
- **功能说明**：演示 LaTeX 导出流程
- **证据文件**：
  - [web_real_export_output.tex](<repo-root>/temp/web_to_core/web_real_export_output.tex)
- **录制建议**：
  - 点击 "导出 LaTeX" 按钮
  - 展示自动导出的 IR 文件
